...
* подготовка данных (очистка, разбиение на смысловые отрезки) с использованием LLM, таких как **Gemini** или **Claude**
* векторизация данных с помощью **YandexEmbedings** 
* сохранение векторов в специальном хранилище [LanceDB](https://lancedb.com/)

при комбинации библиотек [LangChain](https://www.langchain.com/) и 
[YandexChain](https://github.com/yandex-datasphere/yandex-chain), 
для эмбедингов использовались YandexEmbedings,
в качестве основного LLM - **YandexGPT** (хотя и были неудачные попытки построить работу на HuggingFace).
